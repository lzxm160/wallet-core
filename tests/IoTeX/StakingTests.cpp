...
//     action->set_payload(payload.c_str());
//     auto staking = input.mutable_staking();
//     staking->set_allocated_stakeunstake(action);
...
//     action->set_payload(payload.c_str());
//     auto staking = input.mutable_staking();
//     staking->set_allocated_stakewithdraw(action);
...
//     auto action = new IoTeX::Proto::Staking_CandidateRegister();
...
//     auto action = new IoTeX::Proto::Staking_CandidateBasicInfo();
