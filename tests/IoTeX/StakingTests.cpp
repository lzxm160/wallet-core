...
TEST(TWIoTeXStaking, Create) {
    ...
    // "0a29696f313964307033616834673877773964376b63786671383779786537666e7238"
    //                         "727074683573686a120331303018904e20012a077061796c6f6164");
    const char* candidate = "io19d0p3ah4g8ww9d7kcxfq87yxe7fnr8rpth5shj";
    const char* amount = "100";
    const char* payload = "payload";
    auto result = stakingCreate(candidate, amount, 10000, true, payload);
    ASSERT_EQ(*result, "0a29696f313964307033616834673877773964376b63786671383779786537666e7238"
                       "727074683573686a120331303018904e20012a077061796c6f6164");
}
...
//     ASSERT_EQ(hex(*result),
//     "080a1229696f3178707136326177383575717a72636367397935686e727976386c6432"
...
//         auto stake =
//             WRAPD(candidateRegister(name.get(), operatorAddress.get(), reward.get(),
//             amount.get(),
